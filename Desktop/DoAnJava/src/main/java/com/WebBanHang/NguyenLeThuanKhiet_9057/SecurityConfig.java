package com.WebBanHang.NguyenLeThuanKhiet_9057;

import com.WebBanHang.NguyenLeThuanKhiet_9057.service.UserService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http.authorizeHttpRequests(auth -> auth.requestMatchers("/css/**", "/js/**", "/", "/oauth/**", "/register", "/error", "/staffs")
            .permitAll() // Cho phép truy cập không cần xác thực.
            .requestMatchers("/staffs/edit/**", "/staffs/add", "/roles/delete", "/roles/edit/**", "/roles/add", "/roles/delete")
            .hasAnyAuthority("ADMIN") // Chỉ cho phép ADMIN truy cập.
            .requestMatchers("/api/**")
            .permitAll() // API mở cho mọi người dùng.
            .anyRequest().authenticated() // Bất kỳ yêu cầu nào khác ần xác thực.
            ...
            .defaultSuccessUrl("/") // Trang sau đăng nhập thành công.BÀI 5 XÂY DỰNG CÁC CHỨC NĂNG XÁC THỰC VÀ PHÂN QUYỀN NGƯỜI DÙNG 79
